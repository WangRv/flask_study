...
def send_new_comment_email(post):
    ...
    send_html_email(subject="New comment", to=current_app.config["ADMIN_EMAIL"], html=html_body)
...
def send_new_reply_email(comment):
    ...
    send_html_email(subject="New reply", to=current_app.config["ADMIN_EMAIL"], html=html_body)
